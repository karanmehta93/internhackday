...
public class UserProfile extends Activity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findfriends.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent intent = new Intent(UserProfile.this, LocationActivity.class);
        startActivity(intent);
      }
    });
  ...
  public void setUserProfile(JSONObject response) {
    ...
    try {
      ...
      editor.putString(Constants.Name, response.get("formattedName").toString());
      editor.putString(Constants.Email, response.get("emailAddress").toString());
      editor.putString(Constants.Image, response.getString("pictureUrl"));
      editor.putString(Constants.Profile, response.getString("publicProfileUrl"));
